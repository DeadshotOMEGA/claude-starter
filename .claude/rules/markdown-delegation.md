...
**ALWAYS delegate markdown file operations to the `doc-orchestrator` agent.**
...
- Making a single-line typo fix
- The user explicitly says "edit directly, don't delegate"
- Adding a simple comment or annotation
