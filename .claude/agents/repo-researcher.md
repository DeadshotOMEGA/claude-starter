...
description: Analyze code repositories, GitHub projects, and technical documentation. Use PROACTIVELY for evaluating libraries, finding implementation patterns, and comparing technical solutions.
...
tiers: [1]
category: research
capabilities: [code-analysis, repository-evaluation, documentation-review, library-assessment]
triggers: [analyze-repo, evaluate-library, technical-docs, github, implementation-patterns]
parallel: true
-->
