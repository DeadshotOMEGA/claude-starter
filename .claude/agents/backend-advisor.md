...
allowedAgents: Explore, database-architect, sql-pro
model: sonnet
color: magenta
---
...
tiers: [2]
category: expertise
capabilities: [api-design, microservices, database-schema, scalability]
triggers: [api, backend, microservice, schema, scalability]
parallel: true
-->
