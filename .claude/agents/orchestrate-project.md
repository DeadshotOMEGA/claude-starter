...
tiers: [3]
category: planning
capabilities: [workflow-management, agent-coordination, intent-detection, conditional-dispatch]
triggers: [orchestrate, coordinate, workflow, multi-agent, pipeline]
parallel: false
-->
