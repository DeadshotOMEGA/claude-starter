...
capabilities: [react, performance, optimization, profiling, bundle, rendering, memory]
triggers: [performance, optimize, slow, bottleneck, bundle, react, memory, rendering]
parallel: true
-->
