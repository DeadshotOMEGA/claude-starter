...
description: Coordinate comprehensive research projects with multiple specialized agents. Use PROACTIVELY for complex research requiring multiple phases and specialized researchers.
tools: Read, Write, Edit, Task, TodoWrite
skills: executing-parallel-work
allowedAgents: research-specialist, search-specialist, technical-researcher, library-docs-writer, report-generator, Explore
model: opus
color: yellow
tiers: [3]
---
...
tiers: [3]
category: planning
capabilities: [research-coordination, multi-phase-research, agent-delegation, quality-control]
triggers: [research, comprehensive-research, multi-phase, research-project]
parallel: false
-->
