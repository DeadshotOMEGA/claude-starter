---
name: applying-devops-patterns
description: DevOps patterns, templates, and infrastructure code examples for CI/CD pipelines, Infrastructure as Code, Kubernetes deployments, monitoring stacks, security scanning, and deployment strategies. Use when implementing CI/CD workflows, Terraform infrastructure, Kubernetes deployments, or monitoring solutions.
---

# Applying DevOps Patterns

Comprehensive code examples and patterns for modern DevOps implementations.
...
5. **Comprehensive health checks** - Graceful failure recovery
